...
%%%% bookpart_1/Parts/instrument_library/_user_instruments/user_instrument_5.ily
%%%% version: 3.1.2
...
notes_user_instrument_five_bookpart_one = \relative c' {
  \no_music % remove when inputting notes
}

part_user_instrument_five_bookpart_one = \new Staff \with {
  % instrumentName = ""
  % shortInstrumentName = ""
  % midiInstrument = ""
