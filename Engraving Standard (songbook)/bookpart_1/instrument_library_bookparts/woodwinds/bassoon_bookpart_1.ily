...
%%%% bookpart_1/instrument_library_bookparts/woodwinds/bassoon_bookpart_1.ily
%%%% version: 3.1
...
\bookpart {
  \header {
    ...
    % subtitle        = ""
    % subsubtitle     = ""
    instrument        = "Bassoon" % "Part" would be an apt name, as this could easily say "full score". I could change it, but the whole point is to leave as much Lilypond's standards as possible.
    % composer        = ""
    % arranger        = ""
    % poet            = ""
    % meter           = ""
  ...
  % Articulated MIDI score block %
    ...
    \score { \unfoldRepeats \articulate << \scoring_bassoon_bookpart_one >> \midi { \set Score.midiChannelMapping = #'instrument } }
}